...
import egovframework.expend.common.vo.EaFormVO;
...
public class CommonInfoDAO extends AbstractDAO {
    ...
    public ConnectionVO SelectCommonConnectionInfo ( Map<String, Object> param ) {
        ...
        if(servletRequest.getServerName().contains("localhost") || servletRequest.getServerName().contains("127.0.0.1")) {
            conVo = (ConnectionVO) selectOne( "CommonDAO.SelectCommonConnectionInfoTest", param );
        }else{
            conVo = (ConnectionVO) selectOne( "CommonDAO.SelectCommonConnectionInfo", param );
        }
        return conVo;
    }
