package egovframework.ac.g20.code.web;
...
public class AcG20CodeController {
	...
	public String getErpTradeList(@RequestParam Map<String, String> paraMap, Model model) throws Exception{
		...
		try {
			...
			selectList = new ArrayList<>();
					//acG20CodeService.getErpTradeList(conVo, paraMap);
		} catch (Exception e) {
			e.printStackTrace();
			LOG.error(e);
		}
