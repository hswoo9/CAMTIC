package egovframework.ac.g20.ex.service.impl;

import egovframework.ac.cmm.service.AcCommonService;
import egovframework.ac.cmm.service.CommFileService;
import egovframework.ac.cmm.vo.ConnectionVO;
import egovframework.ac.consdocmng.dao.ConsDocMngDAO;
import egovframework.ac.consdocmng.service.ConsDocMngService;
import egovframework.ac.g20.code.dao.AcG20CodeErpDAO;
import egovframework.ac.g20.ex.dao.AcG20Ex2GwDAO;
import egovframework.ac.g20.ex.dao.AcG20ExErpDAO;
import egovframework.ac.g20.ex.dao.AcG20ExGwDAO;
import egovframework.ac.g20.ex.service.AcG20ExService;
import egovframework.devjitsu.common.dto.LoginVO;
import egovframework.devjitsu.common.repository.CodeDAO;
import egovframework.devjitsu.common.repository.CommFileDAO;
...
import egovframework.devjitsu.intra.purc.repository.PurcRepository;
import egovframework.devjitsu.intra.purc.vo.*;
import egovframework.neos.cmm.util.excel.ExcelRead;
import egovframework.neos.cmm.util.excel.ExcelReadOption;
...
//		map.put("purcReqHList", acG20ExGwDAO.getPurcReqH(paramMap));
	...
	public Map<String, Object> getContMod(HashMap<String, Object> requestMap) throws Exception {
		...
		requestMap.put("purcContId", purcContInfo.get("PURC_CONT_ID_BEFORE"));
