...
public class DocViewProcessServiceImpl implements DocViewProcessService {
    ...
    @Override
    public void updateCondDocState(Map<String, Object> bodyMap) throws Exception {
        bodyMap.put("docSts", bodyMap.get("approveStatCode"));
        String docSts = String.valueOf(bodyMap.get("docSts"));
        String approKey = String.valueOf(bodyMap.get("approKey"));
        String docId = String.valueOf(bodyMap.get("docId"));
        ...
        if("10".equals(docSts) || "50".equals(docSts)) { // 상신 - 재상신
            docViewProcessRepository.updateCondApprStat(params);
        }else if("20".equals(docSts)) { // 중간결재
            docViewProcessRepository.updateCondApprStat(params);
        }else if("30".equals(docSts) || "40".equals(docSts)) { // 반려 - 회수
            docViewProcessRepository.updateCondApprStat(params);
            ...
            params.put("approveStatCode", 100);
            docViewProcessRepository.updateCondFinalApprStat(params);
        }else if("111".equals(docSts)){ // 임시저장
            docViewProcessRepository.updateCondApprStat(params);
        }
    }
    ...
    @Override
    public void updateLeaveDocState(Map<String, Object> bodyMap) throws Exception {
        bodyMap.put("docSts", bodyMap.get("approveStatCode"));
        String docSts = String.valueOf(bodyMap.get("docSts"));
        String approKey = String.valueOf(bodyMap.get("approKey"));
        String docId = String.valueOf(bodyMap.get("docId"));
        ...
        if("10".equals(docSts) || "50".equals(docSts)) { // 상신 - 재상신
            docViewProcessRepository.updateLeaveApprStat(params);
        }else if("20".equals(docSts)) { // 중간결재
            docViewProcessRepository.updateLeaveApprStat(params);
        }else if("30".equals(docSts) || "40".equals(docSts)) { // 반려 - 회수
            docViewProcessRepository.updateLeaveApprStat(params);
            ...
            params.put("approveStatCode", 100);
            docViewProcessRepository.updateLeaveFinalApprStat(params);
        }else if("111".equals(docSts)){ // 임시저장
            docViewProcessRepository.updateLeaveApprStat(params);
        }
    }
    ...
    @Override
    public void updateReinstatDocState(Map<String, Object> bodyMap) throws Exception {
        bodyMap.put("docSts", bodyMap.get("approveStatCode"));
        String docSts = String.valueOf(bodyMap.get("docSts"));
        String approKey = String.valueOf(bodyMap.get("approKey"));
        String docId = String.valueOf(bodyMap.get("docId"));
        ...
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("reinstatSn", approKey);
        params.put("docName", bodyMap.get("formName"));
        params.put("docId", docId);
        params.put("docTitle", bodyMap.get("docTitle"));
        params.put("approveStatCode", docSts);
        ...
        if("10".equals(docSts) || "50".equals(docSts)) { // 상신 - 재상신
            docViewProcessRepository.updateReinstatApprStat(params);
        }else if("20".equals(docSts)) { // 중간결재
            docViewProcessRepository.updateReinstatApprStat(params);
        }else if("30".equals(docSts) || "40".equals(docSts)) { // 반려 - 회수
            docViewProcessRepository.updateReinstatApprStat(params);
            ...
            params.put("approveStatCode", 100);
            docViewProcessRepository.updateReinstatFinalApprStat(params);
        }else if("111".equals(docSts)){ // 임시저장
            docViewProcessRepository.updateReinstatApprStat(params);
        }
    }
    ...
    @Override
    public void updatePoemDocState(Map<String, Object> bodyMap) throws Exception {
        bodyMap.put("docSts", bodyMap.get("approveStatCode"));
        String docSts = String.valueOf(bodyMap.get("docSts"));
        String approKey = String.valueOf(bodyMap.get("approKey"));
        String docId = String.valueOf(bodyMap.get("docId"));
        ...
        if("10".equals(docSts) || "50".equals(docSts)) { // 상신 - 재상신
            docViewProcessRepository.updatePoemApprStat(params);
        }else if("20".equals(docSts)) { // 중간결재
            docViewProcessRepository.updatePoemApprStat(params);
        }else if("30".equals(docSts) || "40".equals(docSts)) { // 반려 - 회수
            docViewProcessRepository.updatePoemApprStat(params);
            ...
            params.put("approveStatCode", 100);
            docViewProcessRepository.updatePoemFinalApprStat(params);
        }else if("111".equals(docSts)){ // 임시저장
            docViewProcessRepository.updatePoemApprStat(params);
        }
    }
