...
public class PayAppController {
    ...
    public String getPaymentListForExcelDown(@RequestParam Map<String, Object> params, Model model){
        ...
        List<Map<String, Object>> list = payAppService.getPaymentListForExcelDown(params);
        model.addAttribute("list", list);
    ...
    public String getPayAppData(@RequestParam Map<String, Object> params, Model model){
        ...
        if(map.containsKey("LINK_KEY_TYPE") && map.get("LINK_KEY_TYPE").equals("구매")){
    ...
    @RequestMapping("/pay/getExnpListForExcelDown")
    public String getExnpListForExcelDown(@RequestParam Map<String, Object> params, Model model){
        List<Map<String, Object>> list = payAppService.getExnpListForExcelDown(params);
    ...
    @RequestMapping("/pay/getIncpListForExcelDown")
    public String getIncpListForExcelDown(@RequestParam Map<String, Object> params, Model model){
        List<Map<String, Object>> list = payAppService.getIncpListForExcelDown(params);
        model.addAttribute("list", list);
        return "jsonView";
    }
    ...
    @RequestMapping("/payApp/regIncpCancel")
    public String regIncpCancel(@RequestParam Map<String, Object> params, Model model){

        try{

            payAppService.regIncpCancel(params);
            model.addAttribute("code", 200);
        } catch(Exception e){
            e.printStackTrace();
        }
    ...
    /**
     * parameter
     * exnpSn, type (app, resolution)
     *
     * @param params
     * @param model
     * @return
     */
    @RequestMapping("/payApp/g20ExnpManage")
    public String g20ExnpManage(@RequestParam Map<String, Object> params, Model model) {
