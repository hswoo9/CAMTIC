...
//            commonRepository.insFileInfo(list);
    ...
    public List<Map<String, Object>> getExnpListForExcelDown(Map<String, Object> params) {
        return payAppRepository.getExnpListForExcelDown(params);
    }
...
//                Map<String, Object> taxMap = payAppRepository.getTaxMap(data);
                    ...
                    if(type.equals("resolution") || (data.get("EVID_TYPE").toString().equals("1") || data.get("EVID_TYPE").toString().equals("2") || data.get("EVID_TYPE").toString().equals("3"))
                        ...
                        if(list.size() == i) {
                            data.put("LOGIN_EMP_CD", loginMap.get("DUZON_CODE"));
...
//            commonRepository.insFileInfo(list);
    ...
    public Map<String, Object> setIncpRe(Map<String, Object> params) {
        ...
        for(Map<String, Object> map : itemArr){
            ...
            paramsMap.put("g20EmpCd", params.get("g20EmpCd"));
            paramsMap.put("g20DeptCd", params.get("g20DeptCd"));
            paramsMap.put("busnCd", params.get("busnCd"));
            paramsMap.put("busnExCd", params.get("busnExCd"));
