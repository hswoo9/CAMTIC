...
public class PayAppRepository extends AbstractDAO {
    ...
    public List<Map<String, Object>> getPaymentMngList(Map<String, Object> params) {
        return selectList("payApp.getPaymentMngList", params);
    }

    public List<Map<String, Object>> getPaymentListForExcelDown(Map<String, Object> params) {
        return selectList("payApp.getPaymentListForExcelDown", params);
    }
    ...
    public List<Map<String, Object>> getExnpDetailDataDupl(Map<String, Object> params) {
        return selectList("payApp.getExnpDetailDataDupl", params);
    }
    ...
    public List<Map<String, Object>> getExnpListForExcelDown(Map<String, Object> params) {
        return selectList("payApp.getExnpListForExcelDown", params);
    }
    ...
    public List<Map<String, Object>> getIncpListForExcelDown(Map<String, Object> params) {
        return selectList("payApp.getIncpListForExcelDown", params);
    }
    ...
    public void insPayAppFileCopy(Map<String, Object> params) {
        insert("payApp.insPayAppFileCopy", params);
    }
    ...
    public Map<String, Object> getPayAppDocFileInfo(Map<String, Object> params) {
        return (Map<String, Object>) selectOne("payApp.getPayAppDocFileInfo", params);
    }

    public List<Map<String, Object>> getExnpFileList(Map<String, Object> params) {
        return selectList("payApp.getExnpFileList", params);
    }
    ...
    public List<Map<String, Object>> getIncpBudgetList(Map<String, Object> params) {
        return selectList("payApp.getIncpBudgetList", params);
    }

    public List<Map<String, Object>> getExnpBudgetList(Map<String, Object> params) {
        return selectList("payApp.getExnpBudgetList", params);
    }
}
