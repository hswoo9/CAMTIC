...
public class ProjectRepository extends AbstractDAO {
    ...
    public Map<String, Object> getProjectDataOne(Map<String, Object> params) {
        return (Map<String, Object>) selectOne("project.getProjectDataOne", params);
    }
...
//        update("bustrip.updBustPjtsnReset", params);
    ...
    public void updDevInfoAmt(Map<String, Object> params) {
        update("project.updDevInfoAmt", params);
    }
    ...
    public Map<String, Object> getCbAmtByAccount(Map<String, Object> map) {
        return (Map<String, Object>) selectOne("project.getCbAmtByAccount", map);
    }
    ...
    public List<Map<String, Object>> getPartRateMemberList(Map<String, Object> params) {
        return selectList("project.getPartRateMemberList", params);
    }

    public List<Map<String, Object>> getPsMemberList(Map<String, Object> params) {
        return selectList("project.getPsMemberList", params);
    }
    ...
    public void updPayAppTeamType(Map<String, Object> params) {

        update("project.updPayAppTeamType", params);
    }
