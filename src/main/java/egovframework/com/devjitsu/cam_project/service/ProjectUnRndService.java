...
public interface ProjectUnRndService {
    ...
    List<Map<String, Object>> getLectureStat(Map<String, Object> params);
    ...
    void updLectureInfo2(Map<String, Object> params, MultipartHttpServletRequest request, String SERVER_DIR, String BASE_DIR);
    ...
    void delLecture(Map<String, Object> params);
    void delConsulting(Map<String, Object> params);
