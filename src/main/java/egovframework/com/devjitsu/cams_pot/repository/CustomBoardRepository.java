...
public class CustomBoardRepository extends AbstractDAO {
	...
	public void setScheduleDel(Map<String, Object> params) { update("cb.setScheduleDel", params);}
	...
	public List<Map<String, Object>> getRequestBoardList2(Map<String, Object> params){ return selectList("cb.getRequestBoardList2", params);}
