...
public interface PurcService {
    ...
    List<Map<String, Object>> purcUserPayFileList(Map<String, Object> params);
    ...
    List<Map<String, Object>> getPurcReqClaimList2(Map<String, Object> params);
    ...
    List<Map<String, Object>> getCrmFileList(Map<String, Object> params);
}
