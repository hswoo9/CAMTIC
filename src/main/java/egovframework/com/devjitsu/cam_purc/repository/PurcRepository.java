...
public class PurcRepository extends AbstractDAO {
    ...
    public List<Map<String, Object>> getClaimExnpDetailList(Map<String, Object> params) {
        return selectList("purc.getClaimExnpDetailList", params);
    }

    public void insClaimExnpDetail(Map<String, Object> map) {
        insert("purc.insClaimExnpDetail", map);
    }
    ...
    public List<Map<String, Object>> getPurcReqClaimList2(Map<String, Object> params) {
        return selectList("purc.getPurcReqClaimList2", params);
    }

    public List<Map<String, Object>> getPurcReqClaimEmpList(Map<String, Object> params) {
        return selectList("purc.getPurcReqClaimEmpList", params);
    }
    ...
    public List<Map<String, Object>> getClaimExnpDataByPay(Map<String, Object> map) {
        return selectList("purc.getClaimExnpDataByPay", map);
    }
