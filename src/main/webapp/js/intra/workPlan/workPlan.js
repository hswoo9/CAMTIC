        ...
        columns: [
            {
                ...
                template : function(e){
                    if(e.STATUS == "0"){
                        return "<button type='button' class='k-button k-button-md k-rounded-md k-button-solid k-button-solid-base' onclick=\"workPlanDrafting("+e.WORK_PLAN_CHANGE_ID+", 'drafting')\">" +
                            "<span class='k-icon k-i-track-changes-accept k-button-icon'></span>" +
                            "<span class='k-button-text'>상신</span>" +
                            "</button>";
                    } else if(e.STATUS == "30" || e.STATUS == "40"){
                        return "<button type='button' class='k-button k-button-md k-rounded-md k-button-solid k-button-solid-base' onclick=\"workPlanReDrafting("+e.DOC_ID+", "+e.WORK_PLAN_CHANGE_ID+", 'reDrafting')\">" +
                            "<span class='k-icon k-i-track-changes-accept k-button-icon'></span>" +
                            "<span class='k-button-text'>재상신</span>" +
                            "</button>";
                    } else if(e.STATUS == "10" || e.STATUS == "20" || e.STATUS == "50"){
                        return "<button type='button' class='k-button k-button-md k-rounded-md k-button-solid k-button-solid-base' onclick=\"workPlanApprovalRetrieve("+e.DOC_ID+", "+e.WORK_PLAN_CHANGE_ID+", 'retrieve')\">" +
                            "<span class='k-icon k-i-track-changes-reject k-button-icon'></span>" +
                            "<span class='k-button-text'>회수</span>" +
                            "</button>";
                    } else if(e.STATUS == "111"){
                        return "<button type='button' class='k-button k-button-md k-rounded-md k-button-solid k-button-solid-base' onclick=\"workPlanTempDrafting("+e.DOC_ID+", "+e.WORK_PLAN_CHANGE_ID+", 'tempDrafting')\">" +
                            "<span class='k-icon k-i-track-changes-accept k-button-icon'></span>" +
                            "<span class='k-button-text'>상신</span>" +
                            "</button>";
                    } else{
...
function workPlanApprovalRetrieve(docId, workPlanChangeId, type){
    if(confirm("문서를 회수하시겠습니까?")){
        $.ajax({
            ...
            data : {
                empSeq : $("#empSeq").val(),
                docId : docId,
                workPlanChangeId : workPlanChangeId,
...
$("#apply_month, #start_date, #end_date, #work_plan_type, .startTimePicker, .endTimePicker").attr("readonly", true);
...
function wptSearchCode(type) {
    var itemType = allApplyRadioGroupMake(type);
    var defaultType = {
        "WK_CODE": "",
        "WK_CODE_NM": "선택하세요"
    }
