...
var bgView = {
        ...
        let dataSource = new kendo.data.DataSource({
            ...
            transport: {
                ...
                parameterMap: function(data){
                    ...
                    data.startDt = $("#g20FrDt").val().substring(0,4) + "-" + $("#g20FrDt").val().substring(4,6) + "-" + $("#g20FrDt").val().substring(6,8);
                    data.endDt = $("#g20ToDt").val().substring(0,4) + "-" + $("#g20ToDt").val().substring(4,6) + "-" + $("#g20ToDt").val().substring(6,8);
    ...
    fn_selBudgetInfo: function (cd, name, idx, subAm){
        ...
        if(name != "기타 / 기타 / 기타"){
            if($("#status").val() != "incp"){
                if($("#payAppType").val() == "1" || $("#status").val() == "rev"){
                    if(subAm <= 0) {
                        alert("예산잔액이 부족합니다.");
                        return;
                    }
