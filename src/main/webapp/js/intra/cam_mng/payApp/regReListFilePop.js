    ...
    fn_setFile : function(){
        ...
        if(fileArray.length > 0){
            ...
            for (var i = 0; i < fileArray.length; i++) {
                ...
                html += '   <td style="text-align: left"><span style="cursor: pointer;" onclick="fileDown(\''+fileArray[i].file_path+fileArray[i].file_uuid+'\', \''+fileArray[i].file_org_name+'.'+fileArray[i].file_ext+'\')">' + fileArray[i].file_org_name + '</span></td>';
