var personalInformation = {
    ...
    dataSet : function(){
        ...
        personalInformation.fn_setRegDateForm("regDateCaseA");
        personalInformation.fn_setRegDateForm("regDateCaseB");
        personalInformation.fn_setRegDateForm("birthDay");
        personalInformation.fn_setRegDateForm("sDate");
        personalInformation.fn_setRegDateForm("eDate");
        ...
        $("#divis").kendoDropDownList({
            ...
            change : function (e){
                ...
                if(divis == "4"){
                    ...
                    personalInformation.fn_caseBRollBack();
                    personalInformation.fn_caseCRollBack();
                    personalInformation.fn_caseDRollBack();
                    personalInformation.fn_caseERollBack();
                } else if (divis == '3'){
                    personalInformation.fn_showDivisDet();
                    personalInformation.fn_caseCRollBack();
                    personalInformation.fn_caseDRollBack();
                    personalInformation.fn_caseERollBack();
        ...
        personalInformation.global.dropDownDataSource = customKendo.fn_customAjax("/system/commonCodeManagement/getCmCodeList", {cmGroupCodeId : "4"});
        customKendo.fn_dropDownList("position", personalInformation.global.dropDownDataSource, "CM_CODE_NM", "CM_CODE", 2);
        ...
        personalInformation.global.dropDownDataSource = customKendo.fn_customAjax("/system/commonCodeManagement/getCmCodeList", {cmGroupCodeId : "9"});
        customKendo.fn_dropDownList("occupationCode", personalInformation.global.dropDownDataSource, "CM_CODE_NM", "CM_CODE", 2);

        personalInformation.global.dropDownDataSource = customKendo.fn_customAjax("/system/commonCodeManagement/getCmCodeList", {cmGroupCodeId : "3"});
        customKendo.fn_dropDownList("duty", personalInformation.global.dropDownDataSource, "CM_CODE_NM", "CM_CODE", 2);
        ...
        personalInformation.fn_setRegDateForm("regDate");
    ...
    dataSetChange : function() {
        if($("#holidayCate").val() != '' && $("#holidayCate").val() == 0) {
            ...
            var html2 = '<table class="table table-bordered mb-0" id="holidayPlanReqPopTbVal">\n' +
                ...
                '                   <button class="k-grid-button k-button k-button-md k-button-solid k-button-solid-base" onclick="personalInformation.searchHolidayPop();" type="button"><i class="fa fa-search"></i></button>\n' +
                '                </td>\n' +
                '              </tr>\n' +
                '              <tr>\n' +
                '                <th>기간</th>\n' +
    ...
    personalInformationImage : function() {
        var url = "/Inside/pop/personalInformationImage.do";
