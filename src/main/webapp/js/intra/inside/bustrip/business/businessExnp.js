var busiExnp = {
    ...
    fn_pageSet: function(){
        ...
        if(hrBizReqId != ""){
            ...
            }else if(e.PAY_APP_SN != ""){
                html += '<td style="text-align: center"><button type="button" class="k-button k-button-solid-base" onclick="bustPop.fn_reqRegPopup('+e.HR_BIZ_REQ_RESULT_ID+')">지급신청</button></td>';
            }else{
                html += '<td style="text-align: center"><button type="button" class="k-button k-button-solid-info" onclick="bustPop.fn_reqRegPopup('+e.BF_PAY_APP_SN+', 2)">지급신청</button></td>';
            }
