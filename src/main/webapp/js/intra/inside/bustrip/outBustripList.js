...
var outBustripList = {
    ...
    init : function(){
        outBustripList.dataSet();
        outBustripList.mainGrid();
    },
            ...
            toolbar : [
                {
                    ...
                    name : 'button',
                    template : function (e){
                        return '<button type="button" class="k-grid-button k-button k-button-md k-button-solid k-button-solid-base" onclick="outBustripList.outBustripReqPop()">' +
    ...
    outBustripReqPop : function() {
        var url = "/bustrip/pop/outBustripReqPop.do";
