var approveWaitDocList = {
    ...
    fnDefaultScript : function(params){
        ...
        customKendo.fn_datePicker("startDay", '', "yyyy-MM-dd", new Date(approveWaitDocList.global.now.setMonth(approveWaitDocList.global.now.getMonth() - 1)));
            ...
            toolbar : [
                {
                    name: 'button',
                    template: function (e) {
                        return '<button type="button" class="k-button k-button-md k-button-solid k-button-solid-base" onclick="approveWaitDocList.gridReload()">' +
            ...
            columns: [
                {
                    ...
                    template : function (e){
                        ...
                        if(e.DOC_TITLE == null || e.DOC_TITLE == ""){
                            ...
                            html += '<a href="javascript:approveDocView(' + e.DOC_ID + ',\'' + e.APPRO_KEY + '\',\'' + e.DOC_MENU_CD + '\');" style="color: rgb(0, 51, 255); display:inline-block;"><xmp style="margin: 0">'+textCut(e.DOC_TITLE, 60)+'</xmp></a>';
                        }
