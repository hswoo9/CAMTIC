            ...
            columns: [
                {
                    ...
                    template : function (e){
                        ...
                        if(e.DOC_TITLE == null || e.DOC_TITLE == ""){
                            ...
                            return securityIcon + '<a href="javascript:approveDocView(' + e.DOC_ID + ',\'' + e.APPRO_KEY + '\',\'' + e.DOC_MENU_CD + '\');" style="color: rgb(0, 51, 255); display:inline-block;"><xmp style="margin: 0">'+textCut(e.DOC_TITLE, 51)+'</xmp></a>';
                        }
                    },
                    attributes : {
