var estInfo = {
    ...
    fn_defaultScript : function (){
        ...
        $("#prodCnt, #unitAmt").on("keyup", function(){
            $("#supAmt").val(estInfo.comma(estInfo.uncomma($("#unitAmt").val()) * estInfo.uncomma($("#prodCnt").val())))
        });
    ...
    fn_addClickEvent : function (){
        ...
        var inputData = {
            prodNm : $("#prodNm").val(),
            prodCnt : estInfo.uncomma($("#prodCnt").val()),
            unit : $("#unit").val(),
            unitAmt :estInfo.uncomma($("#unitAmt").val()),
            supAmt : estInfo.uncomma($("#supAmt").val()),
            prodEtc : $("#prodEtc").val(),
        }
        ...
        estInfo.global.totAmt += Number(estInfo.uncomma($("#supAmt" + idx).val()));
        // 견적가 합계 구하기
        ...
        $("#prodCnt" + idx + ", #unitAmt" + idx).on("keyup", function(){
            $("#supAmt" + idx).val(estInfo.comma(estInfo.uncomma($("#unitAmt" + idx).val()) * estInfo.uncomma($("#prodCnt" + idx).val())));
                    ...
                    $("#productTb > tr").each(function (idx){
                        if(idx != 0){
                            var data2 = {
                                ...
                                prodCnt : estInfo.uncomma($("#prodCnt" + idx).val()),
                                unit : $("#unit" + idx).val(),
        ...
        if(rs.result.estList != null && rs.result.estList != "") {
            ...
            $("#productTb > tr").each(function (e) {
                $("#prodCnt" + e + ", #unitAmt" + e).on("keyup", function () {
                    ...
                    $("#supAmt" + e).val(estInfo.comma(estInfo.uncomma($("#unitAmt" + e).val()) * estInfo.uncomma($("#prodCnt" + e).val())));
    ...
    inputNumberFormat : function (obj){
        obj.value = estInfo.comma(estInfo.uncomma(obj.value));
    },
