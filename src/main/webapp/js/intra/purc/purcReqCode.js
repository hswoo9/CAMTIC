...
function getErpBankList(dblClickparamMap){
    ...
    var opt = {
            ...
            successFn : function(){
            	...
            	paramMap.loopData =  mainData.selectList;
            	paramMap.colNames = [
					NeosUtil.getMessage("TX000005280","은행코드"),
					NeosUtil.getMessage("TX000004610","은행명")
				];
...
acG20Code.getErpCardTradeList =  function(dblClickparamMap){
    ...
    var opt = {
            ...
            successFn : function(){
            	...
            	paramMap.loopData =  mainData.selectList;
            	paramMap.colNames = [
					NeosUtil.getMessage("TX000000315","거래처코드"),
					NeosUtil.getMessage("TX000000313","거래처명"),
					NeosUtil.getMessage("TX000000024","사업자번호"),
					NeosUtil.getMessage("TX000005299","대표자성명"),
					NeosUtil.getMessage("TX000000526","카드번호")
				];
