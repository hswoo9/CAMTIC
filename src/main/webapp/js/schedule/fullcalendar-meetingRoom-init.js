! function(e) {
    ...
    t.prototype.onDrop = function(t, n) {
        ...
        if(t.foreignType == "schedule"){
            ...
            meetingRoomReq.meetingRoomPop(t.roomReqSn);
        }
        ...
        var t = new Date,
            ...
            a = meetingRoomReq.getScheduleData(),
            o = this;
    ...
    }, e.CalendarApp = new t, e.CalendarApp.Constructor = t, meetingRoomReq.global.cal = new t, meetingRoomReq.global.cal.Constructor = t
}(window.jQuery),
function(e) {
    "use strict";
    e.CalendarApp.init()
