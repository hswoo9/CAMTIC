! function(e) {
    ...
    t.prototype.onDrop = function(t, n) {
        ...
        if(t.foreignType == "schedule"){
            alert("상세 일정이 없습니다.");
        }else if(t.viewType == '1'){
            bustInfo.bustripReqPop(t.hrBizReqId, 'req', $("#pjtSn").val());
        }else if(t.viewType == '2'){
            bustInfo.fn_regMeetingPop(t.cardToSn, t.hrBizReqId);
        }
    ...
    }, e.CalendarApp = new t, e.CalendarApp.Constructor = t, bustInfo.global.cal = new t, bustInfo.global.cal.Constructor = t
}(window.jQuery),
function(e) {
    "use strict";
    e.CalendarApp.init()
