            ...
            <div>
                <table class="searchTable table table-bordered mb-0">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="itemNo" class="k-input k-textbox" readonly style="width: 78%" onclick="supM.fn_popItemNoList();"/>
                            <button type="button" id="itemSelBtn" class="k-grid-button k-button k-button-md k-button-solid k-button-solid-base" onClick="cir.fn_popItemNoList();">선택</button>
                        </td>
