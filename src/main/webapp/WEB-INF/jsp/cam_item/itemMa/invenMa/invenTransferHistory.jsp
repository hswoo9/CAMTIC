...
<script type="text/javascript" src="<c:url value='/js/intra/cam_item/itemMa/invenMa/invenTransferHistory.js?v=${today}'/>"></script>
...
<div class="mainCard">
    <div class="panel">
        ...
        <div style="padding-left : 20px; padding-right: 20px;">
            <h4 class="panel-title">재고이동현황</h4>
            <div class="title-road">캠아이템 > 아이템관리 > 재고관리 > 재고이동현황</div>
                ...
                <table class="searchTable table table-bordered mb-0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="searchValue" style="width: 60%;" onkeypress="if(window.event.keyCode==13){invenHis.gridReload()}"/>
                        </td>
                    </tr>
                </table>
