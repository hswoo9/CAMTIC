...
<div class="mainCard">
    <div class="panel">
        ...
        <div style="padding-left : 20px; padding-right: 20px;">
            <h4 class="panel-title">구매검수</h4>
            <div class="title-road">캠아이템 > 아이템관리 > 구매관리 > 구매검수</div>
            ...
            <div>
                <table class="searchTable table table-bordered mb-0">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="hidden" id="crmSn" name="crmSn" onchange="purcIns.gridReload();">
                            <input type="text" id="crmNm" style="width: 148px;" readonly onclick="purcIns.fn_popCamCrmList()">
                            <button type="button" class="k-grid-button k-button k-button-md k-button-solid k-button-solid-base" onclick="purcIns.fn_popCamCrmList()">
                                조회
                            </button>
                            <button type="button" class="k-grid-button k-button k-button-md k-button-solid k-button-solid-base" onclick="purcIns.crmSnReset()">
                                초기화
                            </button>
                        </td>
                        <th class="text-center th-color">입고형태</th>
                        <td>
                            <input type="text" id="whType" style="width: 120px;">
                        </td>
