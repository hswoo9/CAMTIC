...
<script type="text/javascript" src="<c:url value='/js/intra/cam_item/itemMa/purcMa/receivingStatus.js?v=${today}'/>"></script>
...
<div class="mainCard">
    <div class="panel">
        ...
        <div style="padding-left : 20px; padding-right: 20px;">
            <h4 class="panel-title">입고현황</h4>
            <div class="title-road">캠아이템 > 아이템관리 > 구매관리 > 입고현황</div>
