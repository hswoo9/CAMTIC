...
<script type="text/javascript" src="<c:url value='/js/intra/cam_item/system/itemMaster/itemMasterList.js?v=${today}'/>"></script>
<style>
    a:hover{
...
<div class="mainCard">
    <div class="panel">
        ...
        <div style="padding-left : 20px; padding-right: 20px;">
            <h4 class="panel-title">품목마스터</h4>
            <div class="title-road">캠아이템 > 시스템관리 > 시스템 > 품목마스터</div>
