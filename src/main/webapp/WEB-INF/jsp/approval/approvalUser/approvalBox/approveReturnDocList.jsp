...
<div class="col-md-10 col-lg-10 dash-left">
    <div class="panel">
        ...
        <h4 class="panel-title">결재반려문서</h4>
            <div class="title-road" style="text-align: right; margin-bottom: 5px;">캠도큐먼트 > 결재함 > 결재반려문서</div>
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class=" k-button k-button-md k-button-solid k-button-solid-base" onclick="approveReturn.gridReload()">
