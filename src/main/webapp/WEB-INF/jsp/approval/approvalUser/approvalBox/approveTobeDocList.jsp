...
<script type="text/javascript" src="<c:url value='/js/intra/approval/approveTobeDocList.js?${toDate}'/>"></script>
...
<div class="col-md-12 col-lg-12 dash-left">
    <div class="panel">
        ...
        <div style="padding-left : 20px; padding-right: 20px;">
            <h4 class="panel-title">결재예정문서</h4>
            <div class="title-road" style="text-align: right; margin-bottom: 5px;">캠도큐먼트 > 전자결재 > 결재함 > 결재예정문서</div>
            ...
            <div class="table-responsive" style="margin-bottom:10px;">
                <table class="searchTable table table-bordered" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="docTitle" onkeypress="if(window.event.keyCode==13){approveTobe.gridReload();}" name="docTitle" style="width: 90%">
                        </td>
                    </tr>
                </table>
            </div>
