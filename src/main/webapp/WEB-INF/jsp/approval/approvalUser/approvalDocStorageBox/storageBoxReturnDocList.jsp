...
<script type="text/javascript" src="<c:url value='/js/intra/approval/storageBoxReturnDocList.js?${toDate}'/>"></script>
...
<div class="col-md-12 col-lg-12 dash-left">
    <div class="panel">
        ...
        <div style="padding-left : 20px; padding-right: 20px;">
            <h4 class="panel-title">반려/회수 문서</h4>
            <div class="title-road" style="text-align: right; margin-bottom: 5px;">캠도큐먼트 > 전자결재 > 상신/보관함 > 반려/회수 문서</div>
