    ...
    <div class="col-md-12 col-lg-12 dash-left">
        <div class="panel">
            ...
            <div style="padding-left : 20px; padding-right: 20px;">
                <h4 class="panel-title">완료문서</h4>
                <div class="title-road" style="text-align: right; margin-bottom: 5px;">캠도큐먼트 > 전자결재 > 상신/보관함 &gt; 완료문서</div>
                ...
                <div style="margin-bottom:10px;">
                    <table class="searchTable table table-bordered" style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="docTitle" onkeypress="if(window.event.keyCode==13){storageBoxResult.gridReload();}" name="docTitle" style="width: 90%">
                            </td>
                        </tr>
                    </table>
                </div>
