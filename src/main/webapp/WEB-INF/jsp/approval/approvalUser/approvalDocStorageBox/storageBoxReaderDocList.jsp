...
<input type="hidden" id="compSeq" value="1212"/>
<input type="hidden" id="groupSeq" value="camtic_new"/>
<div class="col-md-12 col-lg-12 dash-left">
    <div class="panel">
        ...
        <div style="padding-left : 20px; padding-right: 20px;">
            ...
            <div class="title-road" style="text-align: right; margin-bottom: 5px;">캠도큐먼트 > 전자결재 > 상신/보관함 > 열람문서</div>
                ...
                <table class="searchTable table table-bordered" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="docTitle" onkeypress="if(window.event.keyCode==13){storageBoxReader.gridReload();}" name="docTitle" style="width: 75%">
                        </td>
                    </tr>
                </table>
            </div>
