...
<script type="text/javascript" src="<c:url value='/js/intra/cam_mng/payApp/returnList.js?v=${today}'/>"></script>
...
<div class="mainCard">
    <div class="panel">
        ...
        <div style="padding-left : 20px; padding-right: 20px;">
            <h4 class="panel-title">반납 결의서</h4>
            <div class="title-road">캠매니저 > 결의서관리 &gt; 반납 결의서</div>
