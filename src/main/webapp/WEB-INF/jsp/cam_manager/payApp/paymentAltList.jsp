...
<script type="text/javascript" src="<c:url value='/js/intra/cam_mng/payApp/paymentAltList.js?v=${today}'/>"></script>
<style>
    a:hover {
        color: blue;
...
<div class="mainCard">
    <div class="panel">
        ...
        <div style="padding-left : 20px; padding-right: 20px;">
            <h4 class="panel-title">반납신청서 검토 </h4>
            <div class="title-road">캠매니저 > 결의서관리 &gt; 반납신청서 검토</div>
...
<script>
    ...
    paymentAltList.fn_defaultScript();
