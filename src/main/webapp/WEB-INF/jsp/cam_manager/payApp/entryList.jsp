...
<script type="text/javascript" src="<c:url value='/js/intra/cam_mng/payApp/entryList.js?v=${today}'/>"></script>
<style>
    a:hover {
        color: blue;
...
<div class="mainCard">
    <div class="panel">
        ...
        <div style="padding-left : 20px; padding-right: 20px;">
            <h4 class="panel-title">여입 결의서</h4>
            <div class="title-road">캠매니저 > 결의서관리 &gt; 여입 결의서</div>
                ...
                <table class="searchTable table table-bordered mb-0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="searchValue" style="width: 60%;" onkeypress="if(window.event.keyCode==13){entryList.gridReload()}"/>
                        </td>
                    </tr>
                </table>
