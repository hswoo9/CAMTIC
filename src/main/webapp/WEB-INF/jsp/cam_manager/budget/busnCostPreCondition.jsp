...
<script type="text/javascript" src="<c:url value='/js/intra/cam_mng/budget/busnCostPreCondition.js?v=${today}'/>"></script>
<style>
    a:hover {
        color: blue;
...
<div class="mainCard">
    <div class="panel">
        ...
        <div style="padding-left : 20px; padding-right: 20px;">
            <h4 class="panel-title">사업비현황</h4>
            <div class="title-road">캠매니저 &gt; 예산관리 &gt; 예산현황 &gt; 사업비현황 </div>
                ...
                <table class="searchTable table table-bordered mb-0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="searchValue" style="width: 60%;" onkeypress="if(window.event.keyCode==13){busnCostPreCon.gridReload()}"/>
                        </td>
                    </tr>
                </table>
...
<script>
    busnCostPreCon.fn_defaultScript();
</script>
