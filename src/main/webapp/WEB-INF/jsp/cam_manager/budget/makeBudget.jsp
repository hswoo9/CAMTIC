...
<script type="text/javascript" src="<c:url value='/js/intra/cam_mng/budget/makeBudget.js?v=${today}'/>"></script>
<style>
    a:hover {
        color: blue;
...
<div class="mainCard">
    <div class="panel">
        ...
        <div style="padding-left : 20px; padding-right: 20px;">
            <h4 class="panel-title">예산등록</h4>
            <div class="title-road">캠매니저 > 예산관리 &gt; 예산현황 > 예산등록</div>
        ...
        <div class="panel-body">
            <div>
                ...
                <div id="makeBudgetGrid" style="margin:20px 0;"></div>
            </div>
        </div>
    </div>
</div><!-- col-md-9 -->
