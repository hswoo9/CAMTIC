...
<script type="text/javascript" src="<c:url value='/js/intra/cam_mng/budgetPjtChoicePop.js?v=${today}'/>"></script>
...
<div class="col-lg-12 pop_sign_wrap" style="width:1200px; padding:0;">
    ...
    <div style="margin: 0 10px 0 10px;">
        <table class="popTable table table-bordered mb-0">
            ...
            <thead>
            <tr>
                <th class="text-center th-color">사업연도</th>
                <td>
    ...
    <div id="budgetPjtChoice" style="margin: 10px;">

    </div>
</div>
<script>
    budgetPjtChoicePop.fn_defaultScript();
</script>
</body>
