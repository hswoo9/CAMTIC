...
<div class="mainCard">
    <div class="panel">
        ...
        <div style="padding-left : 20px; padding-right: 20px;">
            <h4 class="panel-title">유연근무승인</h4>
            <div class="title-road" style="text-align: right; margin-bottom: 5px;">캠인사이드 > 근태관리 > 유연근무 > 유연근무승인</div>
...
<script type="text/javascript">
    workPlanApp.fn_defaultScript();
    workPlanApp.mainGrid();
</script>