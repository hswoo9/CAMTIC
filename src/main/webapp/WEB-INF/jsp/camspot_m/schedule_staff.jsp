    	...
    	<div id="content">
            ...
            <div class="calenderBox">
            	<div class="month disF jc ac">
            		<a class="controller prev">prev</a>
            		<font><input type="text" class="datepicker" id="day"  placeholder="2024년 03월 15일" /></font>
            		<a class="controller next">next</a>
            	</div>
            </div>
            <!--} 날짜표시 -->
            <!-- 일정 리스트 {-->
            <div class="sclistBox mt40">
            	<span>
