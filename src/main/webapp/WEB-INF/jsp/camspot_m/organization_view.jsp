    	...
    	<div id="content">
            ...
            <div class="titBox">
                ...
                <div id="dropdown_area">
                    <div class="gnb_fml">
                        <a href="#none" class="txt type24">테스트부서 > 경영지원팀
                            <svg viewBox="2154.216 131.6 8.1 4.6"><g transform="translate(1716.69 126)"><path d="M-1336.5,1100.2h8.1l-4,4.6Z" transform="translate(1774.026 -1094.6)"/></g></svg>
                        </a>
                        <a href="#" class="txt type22">테스트부서 > 경영지원팀</a>
                        <a href="#" class="txt type22">미래전략기획본부 > 미래전략기획팀</a>
                        <a href="#" class="txt type22">미래전략기획본부 > J-밸리혁신팀</a>
                        <a href="#" class="txt type22">R&amp;BD사업본부 > 신기술융합팀</a>
                        <a href="#" class="txt type22">R&amp;BD사업본부 > 제조혁신팀</a>
                        <a href="#" class="txt type22">R&amp;BD사업본부 > 복합소재뿌리기술센터</a>
                        <a href="#" class="txt type22">기업성장지원본부 > 창업/기업성장지원팀</a>
                        <a href="#" class="txt type22">기업성장지원본부 > 인재개발팀</a>
                        <a href="#" class="txt type22">일자리혁신지원센터 > 일자리사업팀</a>
                        <a href="#" class="txt type22">일자리혁신지원센터 > 전북조선업도약팀</a>
                        <a href="#" class="txt type22">일자리혁신지원센터 > 익산고용안정팀</a>
                    </div>
                </div>
            ...
            <div class="oviewBox mt20">
            	<div class="disF">
            		<font class="num txt type26">8</font>
                    <div>
                    	<span>
                			<font class="name fP800 txt type30">국민</font>
                			<font class="position txt type22">선임행정원</font>
                        </span>
                        <span class="mt10">
                			<font class="tel txt type22">063-219-0391</font>
                			<font class="phone txt type22">010-3333-5751</font>
                        </span>
                    </div>
                </div>
            	<div class="disF">
