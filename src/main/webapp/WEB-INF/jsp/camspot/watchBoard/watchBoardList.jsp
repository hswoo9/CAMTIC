    ...
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            <div class="btn-st" style="text-align:right;margin:15px 0 0 0;">
                <button type="button" class="k-grid-button k-button k-button-md k-rounded-md k-button-solid k-button-solid-base" onclick="wbl.writePageMove()" id="writeBtn" style="display: none">
