      ...
      <ul class="gnb">
        ...
        <li class="region">
          ...
          <ul>
            ...
            <li class="region_list"><a href="/camtic/region/list.do">입주안내</a></li>
...
<script>
  ...
  /* 입사지원 조회 lnb */
  const jobRecruitCategorie = ['job_applicationRecruitList'];
  if (smallCategory === 'job_applicationRecruitList') {
    smallCategory = 'job_applicationCheck';
  }
