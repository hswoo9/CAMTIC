        ...
        <ul class="innerMain children c">
          <li>
            ...
            <ul class="innerMain children c_a">
              <li><a href="#" class="toggleMain1">개인근태현황</a></li> <%--menu=c_a--%>
              <li><a href="#" class="toggleMain1">개인연차현황</a></li>
              <li><a href="#" class="toggleMain1">개인신청현황</a></li>
          ...
          <li>
            ...
            <ul class="innerMain children c_b">
              <li><a href="#" class="toggleMain1">증명서신청</a></li> <%--menu=c_b--%>
              <li><a href="#" class="toggleMain1">증명서발급</a></li>
            </ul>
          </li>
          <li>
            <a href="#" class="toggleMain">인사관리</a>
            <ul class="innerMain children c_c">
              <li><a href="/appointment/userPersonList.do?menu=c_c" class="toggleMain1">직원조회목록</a></li>
              ...
              <li><a href="/appointment/userPersonnelRecord.do?menu=c_c" class="toggleMain1">인사기록카드</a></li>
            </ul>
          </li>
          <li>
            <a href="#" class="toggleMain">급여</a>
            <ul class="innerMain children c_d">
              <li><a href="#" class="toggleMain1">급여명세서</a></li> <%--menu=c_d--%>
            </ul>
          </li>
          <li>
            ...
            <ul class="innerMain children c_e">
              ...
              <li><a href="/overWk/overWkAdminView.do?menu=c_e" class="toggleMain1">시간외근무현황(관리자)</a></li>
            </ul>
          </li>
          <li>
            ...
            <ul class="innerMain children c_f">
              ...
              <li><a href="/workPlan/workPlanAdminView.do?menu=c_f" class="toggleMain1">유연근무현황(관리자)</a></li>
            </ul>
          </li>
          <li>
            <a href="#" class="toggleMain">출장관리</a>
            <ul class="innerMain children c_g">
              <li><a href="#" class="toggleMain1">출장신청</a></li> <%--menu=c_g--%>
          ...
          <li>
            ...
            <ul class="innerMain children c_h">
              ...
              <li><a href="/subHoliday/subHolidayStatus.do?menu=c_h" class="toggleMain1">휴가현황</a></li>
