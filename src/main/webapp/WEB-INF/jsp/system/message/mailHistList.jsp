...
<script type="text/javascript" src="/js/intra/system/message/mailHistList.js?v=${today}"/></script>
<div class="mainCard">
    <div class="panel">
        <div class="panel-heading">
        </div>
        <div style="padding-left : 20px; padding-right: 20px;">
            <h4 class="panel-title">메일이력</h4>
            <div class="title-road">시스템관리 > 문자 &gt; 메일이력</div>
