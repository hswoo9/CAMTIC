...
<script type="text/javascript" src="/js/intra/campus/openStudyRes.js?v=${toDate}"/></script>
<div class="mainCard">
    <div class="panel">
        <div class="panel-heading">
        </div>
        <div style="padding-left : 20px; padding-right: 20px;">
            <h4 class="panel-title">오픈스터디 관리</h4>
            <div class="title-road">캠퍼스 > 학습관리 > 학습관리 > 오픈스터디 관리</div>
