      ...
      <div id="content">
        ...
        <div class="__jvalley5" style="word-spacing: 5px;">
          ...
          <dl class="what" style="margin-top: 30px;">
            ...
            <dd>
             전주첨단벤처단지는 2001년 전주시와 전북대간 단지 조성 및 운영 협약을 통해 조성되었으며, 연구개발ㆍ기술지원ㆍ교육훈련 등 다양한 분야에서
              기업의 창업 및 혁신성장을 지원하는 산ㆍ학ㆍ연ㆍ관 클러스터 <br>혁신거점 공간입니다.
              ...
              <%--<div class="sec _box1 active">
                ...
                <div class="sec _box1 active">
                  <div class="box">
                    ...
                    <dl>
                      <dt>04</dt>
                      <dd>전북특별자치도 김관영 도지사 벤처단지 내방, 기업간담회 개최</dd>
                    </dl>
                    <dl>
                      <dt>03</dt>
                    ...
                    <dl>
                      <dt>03</dt>
                      <dd>전북특별자치도의회 농산업경제위원회 전주첨단벤처단지 방문</dd>
                    </dl>
                    <dl>
                      <dt>02</dt>
        ...
        <%--<div class="__about1 m0">
          <div class="top">
            <div class="lef">
              지역산업 경쟁력<br class="__p">
              강화를 위한<br>
              <span>산.학.연.관 클러스터 조성</span>
            </div>
            <div class="rig">
              <div class="img"><img src="/images/camtic/img-about1-1.png" alt=""></div>
              <p>-2001.6 벤처단지 조성 협약</p>
            </div>
          </div>
          <div class="bot">
            <div class="__tit2">
            ...
            <div class="tbl">
              <dl class="box">
                ...
                <dd>
                  <dl>
                    <dt><span>'01.6월 전주시</span></dt>
                    <dd>
                      <ul>
                        <li>전북대 간 간지 조성 및 운영을 위한 협약</li>
                      </ul>
                    </dd>
                  </dl>
                </dd>
              ...
              <dl class="box">
                ...
                <dd>
                  <dl>
                    ...
                    <dd>
                      <ul>
                        <li>재정지원/캠틱종합기술원(민간위탁)단지관리 및 기업성장지원</li>
                      </ul>
                    </dd>
                  </dl>
                </dd>
              ...
              <dl class="box">
                ...
                <dd>
                  <dl>
                    ...
                    <dd>
                      <ul>
                        <li>첨단기계.금형.가공.열처리 등 뿌리기업11개사</li>
                      </ul>
                    </dd>
                  </dl>
                  <dl>
                    ...
                    <dd>
                      <ul>
                        <li>
                          드론/UAM, 탄소복합소재, 메카트로닉스.ICT융복합, 스마트팩토리, 스마트팜, SW, 지능형기계부품 등58개사
                        </li>
                      </ul>
                    </dd>
                  </dl>
        ...
        <div class="__tit1 line __mt100">
          <h3><strong>입주기업 실적</strong></h3>
          <p>기업의 매출 성장, 좋은 일자리 창출</p>
        </div>
        <div class="__about2">
          <div class="lef"><img src="/images/camtic/img-about2-1.jpg" alt=""></div>
          <div class="rig"><img src="/images/camtic/img-about2-2.jpg" alt=""></div>
        </div>

        <div class="__tit1 line __mt100">
          <h3><strong>입주기업 대표실적/성과</strong></h3>
          <p>투자유치 및 정부과제 수주 </p>
        </div>
        <div class="__about3">

          <div class="box">
            <div class="img"><img src="/images/camtic/img-about3-1.jpg" alt=""></div>
            <div class="info">
              <dl class="top">
                <dt>(주)씨비에이치 602호</dt>
                <dd>의료용 카본테이블 스마트 척추이완의자</dd>
              </dl>
              <dl class="bot">
                <dt>
                  <dl>
                ...
                <dd>
                  <ul>
                    <li>CKD Start-UP 3호 20억</li>
                    <li>중소벤처기업진흥공단 10억</li>
                    <li>코리아에셋투자증권 10억</li>
                  </ul>
                </dd>
              </dl>
          ...
          <div class="box">
            <div class="img"><img src="/images/camtic/img-about3-2.jpg" alt=""></div>
            <div class="info">
              <dl class="top">
                <dt>(주)플라스바이오 609호</dt>
                <dd>동물실험 자동화 장치</dd>
              ...
              <dl class="bot">
                ...
                <dd>
                  <ul>
                    <li>전북대학연합기술지수 3억</li>
                    <li>KB인베스트먼트 Seed 5억</li>
                    <li>인포뱅크,더넥스트랩 PreA4억</li>
                  </ul>
                </dd>
              </dl>
            </div>
          ...
          <div class="box">
            <div class="img"><img src="/images/camtic/img-about3-3.jpg" alt=""></div>
            <div class="info">
              <dl class="top">
                <dt>(주)애드아임 606호</dt>
                <dd>스마트팩토리 스마트팜</dd>
          ...
          <div class="box">
            <div class="img"><img src="/images/camtic/img-about3-4.jpg" alt=""></div>
            <div class="info">
              <dl class="top">
                <dt>(주)위스 402호</dt>
                <dd>자동소화재떨이</dd>
          ...
          <div class="box">
            <div class="img"><img src="/images/camtic/img-about3-5.jpg" alt=""></div>
            <div class="info">
              <dl class="top">
                <dt>(주)바로텍시너지 404호</dt>
                <dd>항공기 시뮬레이터 제조</dd>
        ...
        <div class="__tit1 line __mt100 mb0">
          <h3><strong>입주기업과의 협력성과</strong></h3>
        </div>
        <div class="__about4">
          <div class="img"><img src="/images/camtic/img-about4-1.jpg" alt=""></div>
          <div class="txt">
            대한드론축구협회,비아,<br class="__p">
            우리아이오<br>
            ANH시스템즈,디클래스,<br class="__p">
            드론프릭
          </div>
          <div class="arr"><img src="/images/camtic/img-about4-2.jpg" alt=""></div>
          <div class="txt2">
            <dl>
              <dt>협력을 통한 정부(국토교통부)과제 공동추진</dt>
              <dd>
                - 드론실증도시구축사업 : 26.7억원(2년)<br>
                - 드론규제샌드박스사업 : 7억원(2년)<br>
                - 수고드론실증사업 : 27억원
              </dd>
            </dl>
          </div>
