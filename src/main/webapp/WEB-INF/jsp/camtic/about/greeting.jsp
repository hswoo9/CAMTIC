    ...
    <div class="inner">
      ...
      <div id="content">
        ...
        <div class="__greeting">
          <dl class="head">
            <dt style="text-align: center"><span class="__nm">“</span><span class="mainCapyTitle">함께 성장하는 행복한 일터</span><span class="__nm">”</span></dt>
          ...
          <div class="mainAbou">
            ...
            <div class="rig" style="width: 400px; padding-top: 50px;">
              ...
              <img src="/images/camtic/greetingTest.png" class="is-m" style="max-width: 100%; width: auto;" alt="원장 노상흡">
            </div>
          </div>
        </div>
      </div>
