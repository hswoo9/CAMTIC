        ...
        <div class="__greeting">
          ...
          <div class="mainAbou">
            <div class="lef" style=" width: 800px;">
              <div class="area">
                <div class="txt">
                  ...
                  <br><br>
                  1999년 12월, 기술혁신을 통한 지역산업 발전을 위하여 설립된 캠틱종합기술원은
                  연구개발, 기술지원, 인재양성, 그리고 일자리 창출 등 다양한 영역에서 국내외 고객과 협력하며
                  지속적으로 성장해 왔습니다.
                  <%--<br><br>
                  1999년 12월부터 시작된 여정에서 캠틱종합기술원은 연구개발, 기술지원, 인재양성, 그리고 일자리 창출 등 여러 분야에서 국내외 고객과 협력하며 지속적으로 성장해 왔습니다.--%>
                  <br><br>
                  그동안 축적된 전문성과 노하우를 바탕으로 드론모빌리티에서부터 탄소복합소재, 바이오헬스케어, 스마트제조로봇, 그리고 우주항공까지 다양한 신기술과 신산업 분야에서 혁신적인 도약을 위한 노력을 지속하고 있습니다.
                  <br><br>
                </div>
                <%--<div class="img">
                  <i></i>
                ...
                <div class="txt">
                  또한, 2002년에 조성된 전주첨단벤처단지 내에 위치한 전주혁신창업허브와 2024년 8월에 준공을 앞둔 성장동을 통해 첨단 및 디지털 산업을 선도할 수 있는 창의적인 플랫폼인 “J-Valley”를 구축하고 확장해 나가고 있습니다.<br>
                  <br>
            ...
            <div class="rig" style="width: 600px; padding-top: 45px;">
              ...
              <img src="/images/camtic/greetingTest4.png" class="is-m" style="max-width: 132%; width: auto; border-radius: 70px; height: 525px; filter: drop-shadow(10px 6px 6px #c3c3c3);" alt="원장 노상흡">
            </div>
          </div>
        </div>
      </div>
