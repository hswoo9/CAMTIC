...
<%--          <div class="__tit2 __mt60">
        ...
        <div class="__tit1 __mt100 __mb20">
          <h3 style="border-bottom: 1px dashed #b7b7b7; padding:30px 0;"><strong>윙윙스테이션 장비 소개</strong></h3>
        </div>
            <div class="area">
        ...
        <div class="__tit1 __mt100 __mb20">
          <h3 style="border-bottom: 1px dashed #b7b7b7; padding:30px 0;"><strong>윙윙스테이션 공간 소개</strong></h3>
        </div>
            <%--<div class="area">
              <div class="box">
                <div class="info _row">
