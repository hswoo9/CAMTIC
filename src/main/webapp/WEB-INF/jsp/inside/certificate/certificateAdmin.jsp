...
<script type="text/javascript" src="/js/intra/inside/certificate/certificateAdmin.js?v=${todate}"/></script>
<script type="text/javascript" src="/js/intra/inside/certificate/certificateList.js?v=${todate}"/></script>
...
<div class="col-md-12 col-lg-12 dash-left">
    <div class="panel">
        ...
        <div style="padding-left : 20px; padding-right: 20px;">
            ...
            <div class="title-road">캠인사이드 > 인사관리 > 증명서 관리 &gt; 증명서 관리</div>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="mr20" style="display: none">
                                <span>처리상태</span>
                                <input type="text" id="status1" style="width: 150px;">
                            </div>
                        </td>
                        ...
                        <td>
                            ...
                            <input type="text" id="searchText" value="" onkeypress="if(window.event.keyCode==13){certificateAdmin.gridReload();}" style="width: 100px;">
                        </td>
                    </tr>
                </table>
