...
<script type="text/javascript" src="/js/intra/inside/recruit/recruitListTl.js?v=${today}"/></script>
<style>
    a:hover{
...
<div class="col-md-12 col-lg-12 dash-left">
    <div class="panel">
        ...
        <div style="padding-left : 20px; padding-right: 20px;">
            <h4 class="panel-title">채용관리(팀장)</h4>
            <div class="title-road">캠인사이드 > 인사관리 > 채용관리 &gt; 채용관리(팀장)</div>
