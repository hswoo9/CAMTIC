...
<div class="col-md-10 col-lg-10 dash-left">
    <div class="panel">
        ...
        <div style="padding-left : 20px; padding-right: 20px;">
            ...
            <div class="title-road" style="text-align: right; margin-bottom: 5px;">캠인사이드 > 발령/포상관리 &gt; 포상 관리</div>
            <div id="startView" style="padding: 10px 0 0 0; border-top: 2px solid #dfdfdf;"></div>
        </div>
        <div class="panel-body">
            <div>
                <table class="searchTable table table-bordered mb-0" style="border: 0; border: 1px solid #dedfdf;">
                    <colgroup>
                        <col width="10%">
                        <col width="25%">
                        <col width="10%">
