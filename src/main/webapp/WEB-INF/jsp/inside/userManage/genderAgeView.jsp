...
<script type="text/javascript" src="/js/intra/inside/userManage/genderAgeView.js?v=${today}"/></script>
...
<div class="mainCard">
    <div class="panel">
        ...
        <div style="padding-left : 20px; padding-right: 20px;">
            <h4 class="panel-title">성별/연령별 현황</h4>
            <div class="title-road">캠인사이드 > 인사관리 > 인사관리 &gt; 인사 통계현황 > 성별/연령별 현황</div>
...
<script type="text/javascript">
    genderAgeView.fn_defaultScript();
</script>