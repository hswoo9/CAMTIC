...
<script type="text/javascript" src="/js/intra/inside/userManage/dutyView.js?v=${today}"/></script>
...
<div class="mainCard">
    <div class="panel">
        ...
        <div style="padding-left : 20px; padding-right: 20px;">
            ...
            <div class="title-road">캠인사이드 > 인사관리 > 인사관리 &gt; 인사 통계현황 > 직급 현황</div>
