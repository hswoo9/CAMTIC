...
<script type="text/javascript" src="/js/intra/inside/bustrip/outBustripList.js?v=${today}"/></script>
...
<div class="col-md-10 col-lg-10 dash-left">
    <div class="panel">
        ...
        <div style="padding-left : 20px; padding-right: 20px;">
            ...
            <div class="title-road" style="text-align: right; margin-bottom: 5px;">캠인사이드 > 출장관리 &gt; 관외출장리스트</div>
