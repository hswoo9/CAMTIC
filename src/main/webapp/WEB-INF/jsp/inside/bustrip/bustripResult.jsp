...
<div class="col-md-10 col-lg-10 dash-left">
    <div class="panel">
        ...
        <div style="padding-left : 20px; padding-right: 20px;">
            ...
            <div class="title-road" style="text-align: right; margin-bottom: 5px;">캠인사이드 > 출장관리 &gt; 출장결과보고서</div>
                    ...
                    <tr>
                        <td style="border-bottom:0; background-color: white">
                            <div style="display:flex;">
                                ...
                                <div class="mr10">
                                    <input type="button" class="k-grid-button k-button k-button-md k-button-solid k-button-solid-base" value="검색" onclick="bustripResult.mainGrid()"/>
                                </div>
                            </div>
                        </td>
                    </tr>
