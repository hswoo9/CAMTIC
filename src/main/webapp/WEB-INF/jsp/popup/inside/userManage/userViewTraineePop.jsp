                ...
                <div class="btn-st popButton">
                    <c:if test="${isAdmin}">
                        <c:if test="${uprinfList.WORK_STATUS_CODE eq 'Y'}">
                            <button type="button" class="k-button k-button-solid-info" onclick="userViewTraineePop.userImageReqPop('${params.empSeq}')">이미지 관리</button>
                            <button type="button" class="k-button k-button-solid-info" onclick="userViewTraineePop.certificateReqPop('${params.empSeq}')">증명서 발급</button>
                            <button type="button" class="k-button k-button-solid-info" onclick="userViewTraineePop.moveToUserReqPop('${params.empSeq}')">편집</button>
                            <button type="button" class="k-button k-button-solid-error" onclick="userViewTraineePop.userResignation('${params.empSeq}')">퇴사처리</button>
                            <button type="button" class="k-button k-button-solid-error" onclick="userViewTraineePop.setUserDel('${params.empSeq}')">삭제</button>
                        </c:if>
                    </c:if>
