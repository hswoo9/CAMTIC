...
<script type="text/javascript" src="<c:url value='/js/intra/inside/userManage/yearDutyViewPop.js'/>"></script>
<link rel="stylesheet" href="/css/quirk.css">
<link rel="stylesheet" href="/css/style.css">
<script>
    var currentYear = '${param.currentYear}';
    var positionName = '${param.positionName}';
...
<script>
    yearDutyViewPop.fn_defaultScript();
</script>
</body>
</html>