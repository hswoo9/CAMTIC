...
<fmt:formatDate value="${today}" var="nowHyphen" pattern="yyyyMMdd" />
...
<script type="text/javascript" src="/js/intra/inside/userManage/userPrintPop.js?v=${today}"></script>
<script type="text/javascript" src="/js/intra/inside/userManage/userPrintHtml.js?v=${today}"></script>
...
<input type="hidden" id="hwpUrl" value="${hwpUrl}">
<div class="pop_head">
    ...
    <div id="docControlBtnDiv">
        <button type='button' class='k-button k-button-solid k-button-solid-base'  style="height: 25px; font-size: 12px;" onclick="userPrintPop.saveHwp()">
            <span class='k-button-text'>한글파일 다운로드</span>
        </button>
        <button type='button' class='k-button k-button-solid k-button-solid-base' id="docApprovalPDFDownBtn"  style="width: 70px; height: 25px; font-size: 12px;" onclick="userPrintPop.print()">
