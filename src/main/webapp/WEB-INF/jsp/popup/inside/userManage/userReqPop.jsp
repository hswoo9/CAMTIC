            ...
            <form id="subHolidayReqPop" style="padding: 0px 10px 0px 10px;">
                ...
                <table class="table table-bordered mb-0" id="userReqPopDetail">
                    ...
                    <tr>
                        ...
                        <th>신장</th>
                        <td>
                            <input type="text" id="height" onKeyup="this.value=this.value.replace(/[^-\.0-9]/g,'');" style="width: 50%;text-align: right"> cm
                        </td>
                    </tr>
                    <tr>
                        <th>체중</th>
                        <td>
                            <input type="text" id="weight" onKeyup="this.value=this.value.replace(/[^-\.0-9]/g,'');" style="width: 50%;text-align: right"> kg
                        </td>
                        <th>시력</th>
                        <td>
