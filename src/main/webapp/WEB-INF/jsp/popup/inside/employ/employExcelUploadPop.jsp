...
<script type="text/javascript" src="/js/intra/inside/userManage/employExcelUploadPop.js?v=${today}"/></script>
    ...
    <div class="table-responsive">
        <div class="card-header pop-header">
            ...
            <div class="btn-st popButton">
                <button type="button" class="k-button k-button-solid-info" style="margin-right:5px;" onclick="employExcel.setExcelFileUpload()">업로드</button>
                ...
                <table class="popTable table table-bordered mb-0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="file" id="file" name="file" onchange="employExcel.fileChange(this)" style="display: none">
                        </td>
                    </tr>
                    </thead>
                </table>
