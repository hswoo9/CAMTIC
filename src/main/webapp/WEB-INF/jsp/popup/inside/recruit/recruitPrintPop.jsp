...
<script type="text/javascript" src="<c:url value='/js/intra/inside/recruit/recruitPrintPop.js?v=2'/>"></script>
...
<div class="pop_head">
    <div style="position: absolute;">
        <h1>채용 지원서류 접수 현황 조회</h1>
    </div>

    <div id="docControlBtnDiv">
        <button type='button' class='k-button k-button-solid k-button-solid-base'  style="height: 25px; font-size: 12px;" onclick="recruitPrintPop.saveHwp()">
