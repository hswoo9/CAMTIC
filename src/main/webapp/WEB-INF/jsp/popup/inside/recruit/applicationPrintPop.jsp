...
<input type="hidden" id="applicationId" value="${data.applicationId}"/>
...
<div class="pop_head">
    ...
    <div id="docControlBtnDiv">
        <button type='button' class='k-button k-button-solid k-button-solid-base'  style="height: 25px; font-size: 12px;" onclick="applicationPrintPop.saveHwp()">
            <span class='k-button-text'>한글파일 다운로드</span>
        </button>
        <button type='button' class='k-button k-button-solid k-button-solid-base' id="docApprovalPDFDownBtn"  style="width: 70px; height: 25px; font-size: 12px;" onclick="applicationPrintPop.print()">
