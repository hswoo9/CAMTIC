...
<script type="text/javascript" src="/js/intra/inside/salaryManage/esmExcelUploadPop.js?v=${today}"/></script>
    ...
    <div class="table-responsive">
        <div class="card-header pop-header">
            ...
            <div class="btn-st popButton">
                <button type="button" class="k-button k-button-solid-info" style="margin-right:5px;" onclick="esmExcel.setExcelFileUpload()">업로드</button>
                ...
                <table class="popTable table table-bordered mb-0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="file" id="file" name="file" onchange="esmExcel.fileChange(this)" style="display: none">
                        </td>
                    </tr>
                    </thead>
                </table>
