...
<script type="text/javascript" src="/js/intra/inside/bustrip/outBustripReqPop.js?v=${today}"></script>
<style>
  .removeDay{
    ...
    <div class="card-header" style="padding-top:45px;">
      <div class="col-lg-11" style="margin:0 auto;">
        <div class="table-responsive">
          <div class="popupTitleSt">관외출장 신청</div>
          <form id="outBustripReqPop">
            ...
            <table class="table table-bordered mb-0" id="outBustripReqPopTb">
              <colgroup>
                <col width="10%">
                <col width="30%">
                <col width="20%">
              ...
              <tr>
                ...
                <th>출장일</th>
                <td>
                  <input type="text" id="date1" style="width: 40%"> ~ <input type="text" id="date2" style="width: 40%">
                </td>
              </tr>
              <tr>
                <th>업무차량</th>
              ...
              <tr>
                <th>교통수단</th>
                <td>
                  <input type="text" id="drop5" style="width: 80%;">
                </td>
                <th>출장지</th>
                <td>
                  <input type="text" id="drop6" style="width: 40%;">
                  <input type="text" id="drop7" style="width: 40%;">
                </td>
              </tr>
              <tr>
                <th>숙박제공</th>
                <td>
                  <input type="text" id="drop8" style="width: 80%;">
                </td>
                <th>식비제공</th>
                <td>
                  <input type="text" id="drop9" style="width: 80%;">
                </td>
              </tr>
              <tr>
                <th>출장목적</th>
