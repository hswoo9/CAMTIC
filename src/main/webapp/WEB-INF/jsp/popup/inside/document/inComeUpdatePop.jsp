...
<script type="text/javascript" src="/js/intra/inside/document/inComePop.js?v=${today}"/>
</script>
    ...
    <div class="table-responsive">
        ...
        <form style="padding: 0px 30px;">
            <div class="card-header" style="padding: 5px;">
                <h3 class="card-title"><span class="red-star"></span>첨부 파일<span class="red-star" style="font-size: 10px; margin-left:12px;">*첨부 파일은 1개만 등록 가능</span></h3>
