            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered mb-0">
                    ...
                    <tr>
                        ...
                        <th scope="row" class="text-center th-color"><span class="red-star"></span>계약 번호</th>
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="deliveryAmount" style="width: 100%; text-align: right;" value="원"></td>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row" class="text-center th-color"><span class="red-star"></span>지급 조건</th>
                        <td><input type="text" id="payment" style="width: 100%;"></td>
                        <th scope="row" class="text-center th-color"><span class="red-star"></span>계약서 유무</th>
                        <td><input type="radio" name="allChk" class="radioV" id="allChkY" value="Y" checked >
                    ...
                    <tr>
                        <th scope="row" class="text-center th-color"><span class="red-star"></span>계약서 (발주서)</th>
                        <td colspan="3"></td>
                    </tr>
                    <tr>
                        <th scope="row" class="text-center th-color"><span class="red-star"></span>납품서</th>
                        <td colspan="3"></td>
                    </tr>
                    <tr>
                ...
                <table class="table table-bordered mb-0">
                    ...
                    <tr>
                        ...
                        <th scope="row" class="text-center th-color"><span class="red-star"></span>상담코드</th>
                        <th scope="row" class="text-center th-color"><span class="red-star"></span>프로젝트 명</th>
                        <th scope="row" class="text-center th-color"><span class="red-star"></span>수주금액(천원)</th>
                        <th scope="row" class="text-center th-color"><span class="red-star"></span>삭제</th>
                    </tr>
                </table>
