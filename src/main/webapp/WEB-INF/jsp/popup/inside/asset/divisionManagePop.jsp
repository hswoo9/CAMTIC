...
<div class="col-lg-12" style="padding:0;">
    <div class="table-responsive">
        <div class="card-header pop-header">
            <h3 class="card-title title_NM">구분관리 추가</h3>
            <div class="btn-st popButton">
                <button type="button" class="k-button k-button-solid-info" onclick="divisionManagePop.fn_saveBtn()">저장</button>
        ...
        <div style="padding: 20px 30px;">
            <table class="popTable table table-bordered mb-0">
                ...
                <tr>
                    ...
                    <td colspan><input type="text" id="astTypeCode" style="width: 100%; margin-right:10px;" maxlength="1"></td>
                </tr>
                </thead>
            </table>
        </div>
