            ...
            <form id="table-responsive" style="padding: 20px 30px;">
                ...
                <table class="popTable table table-bordered mb-0" style="margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="usePdStrDe" type="date" style="width: 40%;" onchange="equipmentUsePop.fn_calTime()" maxlength="10" oninput="formatInputDate(this)">
                            <input id="time1" style="width: 25%" onchange="equipmentUsePop.fn_calTime()" maxlength="5" oninput="inputTimeColon(this)"> ~
                            <input id="time2" style="width: 25%" onchange="equipmentUsePop.fn_calTime()" maxlength="5" oninput="inputTimeColon(this)">
                        </td>
                        <td colspan="2">
                            <input id="usePdEndDe" type="date" style="width: 25%;" onchange="equipmentUsePop.fn_calTime()" maxlength="10" oninput="formatInputDate(this)">
                            <input id="endTime1" style="width: 20%" onchange="equipmentUsePop.fn_calTime()" maxlength="5" oninput="inputTimeColon(this)"> ~
                            <input id="endTime2" style="width: 20%" onchange="equipmentUsePop.fn_calTime()" maxlength="5" oninput="inputTimeColon(this)">
