    ...
    <form id="studyJournalForm">
        <table class="table table-bordered mt20" id="studyJournalTable" style="width: 1000px;">
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="journalDt" style="width: 22%"> <input type="text" id="journalStartTime" maxlength="5" style="width: 22%"> ~ <input type="text" id="journalEndTime" maxlength="5" style="width: 22%">
                </td>
            </tr>
            <tr>
