    ...
    <div class="table-responsive">
        <div class="card-header pop-header">
            ...
            <div class="btn-st popButton">
                ...
                <button type="button" id="stepCBtn" style="display: none" class="k-button k-button-solid-info" onclick="openStudyReq.fn_openNextStep('C');">모임완료</button>
        ...
        <form id="table-responsive" style="padding: 20px 30px;">
            <table class="popTable table table-bordered mb-0">
                ...
                <tr>
                    ...
                    <td>
                        <input id="openStudyName" type="text" style="width: 485px;">
                    </td>
                </tr>
                <tr>
                    <th scope="row" class="text-center th-color">
                ...
                <tr>
                    ...
                    <td>
                        <textarea id="openStudyDetail" style="width: 485px; height: 300px;"></textarea>
                    </td>
                </tr>
                <tr>
                    <th scope="row" class="text-center th-color">
                    ...
                    <td>
                        <input type="text" id="openStudyLocation" style="width: 485px;">
                    </td>
                </tr>
                </thead>
            </table>
