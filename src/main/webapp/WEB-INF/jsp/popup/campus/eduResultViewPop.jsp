  ...
  <div class="card-header" style="padding-top:45px;">
    <div class="col-lg-11" style="margin:0 auto;">
      ...
      <div class="btn-st" style="margin-top:10px; text-align:center;">
        <input type="button" class="k-button k-button-solid-info k-rounded" value="결재요청" onclick="eduResultViewPop.updateApprStat(40);"/>
        <input type="button" class="k-button k-button-solid-info k-rounded" value="결재승인" onclick="eduResultViewPop.updateApprStat(50);"/>
