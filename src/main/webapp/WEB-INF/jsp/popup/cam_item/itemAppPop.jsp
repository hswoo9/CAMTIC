...
<script type="text/javascript" src="/js/intra/cam_item/approve/itemAppPop.js?v=${today}"/></script>
        ...
        <div class="col-lg-11" style="margin:0 auto;">
            <div class="table-responsive">
                <table class="table table-bordered mb-0">
                    ...
                    <tbody>
                    <tr>
                        <th colspan="2">재고현황</th>
                    </tr>
                    <tr>
                        <th scope="row" class="text-center th-color"><span class="red-star"></span>조회년월</th>
                        <td>
                            <form id="invenDeadLineDraftFrm" method="post">
                                <input type="hidden" id="itemApprovalSn" name="itemApprovalSn" value="${params.pk}">
                                <input type="hidden" id="menuCd" name="menuCd" value="item">
            ...
            <div class="btn-st" style="text-align:center; margin-top: 5px;">
                <input type="button" id="approvalBtn" style="" class="k-button k-button-solid k-button-solid-info" value="결재" onclick="itemApp.saveBtn()"/>
                <input type="button" id="approvalViewBtn" style="" class="k-button k-button-solid k-button-solid-info" value="결재문서" onclick="itemApp.viewBtn()"/>
            </div>
        </div>
    </div>
</div>
