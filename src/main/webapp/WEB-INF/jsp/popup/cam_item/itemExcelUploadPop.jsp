...
<script type="text/javascript" src="/js/intra/cam_item/popup/itemExcelUploadPop.js?v=${today}"/></script>
    ...
    <div class="table-responsive">
        <div class="card-header pop-header">
            ...
            <div class="btn-st popButton">
                <button type="button" class="k-button k-button-solid-info" style="margin-right:5px;" onclick="itemExcel.setExcelFileUpload()">업로드</button>
                ...
                <table class="popTable table table-bordered mb-0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="file" id="file" name="file" onchange="itemExcel.fileChange(this)" style="display: none">
                        </td>
                    </tr>
                    </thead>
                </table>
