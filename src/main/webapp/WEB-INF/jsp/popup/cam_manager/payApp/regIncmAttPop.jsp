        ...
        <div class="card-header pop-header">
            ...
            <div id="payAppBtnDiv" class="btn-st popButton" style="font-size: 13px;">
                <c:if test="${params.type != 'exnp'}">
                    <button type="button" class="k-button k-button-solid-info" id="saveBtn" onclick="regIncmAtt.fn_regist();">등록</button>
                </c:if>
                <button type="button" class="k-button k-button-solid-error" onclick="regIncmAtt.fn_close();">닫기</button>
            </div>
        </div>
        <div style="padding: 20px 30px;">
            <c:if test="${params.type != 'exnp'}">
                ...
                <td style="text-align: center;" colspan="5">
                    ...
                    <input type="file" id="payFileList" name="payFileList" onchange="regIncmAtt.fileChange(this)" style="display: none" multiple>
