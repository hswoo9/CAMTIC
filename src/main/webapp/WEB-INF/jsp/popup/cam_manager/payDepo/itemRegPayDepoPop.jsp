...
<script type="text/javascript" src="<c:url value='/js/intra/cam_mng/deposit/itemRegPayDepoPop.js?v=${today}'/>"></script>
    ...
    <div class="table-responsive">
        <div class="card-header pop-header">
            ...
            <div id="payAppBtnDiv" class="btn-st popButton">
                ...
                <button type="button" class="k-button k-button-solid-info" style="display: none;" id="apprBtn" onclick="itemRegPayDepo.fn_apprIncome('${params.payDepoSn}')">수입결의 요청</button>
                <c:if test="${hashMap.PM == 'Y'}"></c:if>
                <button type="button" class="k-button k-button-solid-info" id="saveBtn" onclick="itemRegPayDepo.fn_save();">저장</button>
                ...
                <tr id="project">
                    ...
                    <td colspan="2">
                        <span>
                            ...
                            <button type="button" class="k-button k-button-solid-base" id="pjtSelBtn" onclick="itemRegPayDepo.fn_projectPop('regPay')">검색</button>
                        </span>
                    </td>
                    ...
                    <td colspan="2">
                        <span>
                            ...
                            <button type="button" class="k-button k-button-solid-base" id="bgSelBtn" onclick="itemRegPayDepo.fn_budgetPop()">검색</button>
                        </span>
                    </td>
                </tr>
                <tr>
...
<%--                        <button type="button" id="crmSelBtn" class="crmSelBtn k-grid-button k-button k-button-md k-button-solid k-button-solid-base" onclick="itemRegPayDepo.fn_popCamCrmList();">업체선택</button>--%>
                    </td>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <input type="text" id="depoAmt" style="text-align: right; width: 90%;" value="<fmt:formatNumber value="${params.depositAmt}" pattern="#,###"/>" <%--onkeyup="itemRegPayDepo.fn_calCost(this)" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"--%> disabled>
                    </td>
...
<script type="text/javascript">
    itemRegPayDepo.fn_defaultScript();

    function selectProject(sn, nm, cd, baseYear){
        $("#budgetNm").val("");
        $("#budgetSn").val("");
        itemRegPayDepo.global.setFlag = false;
