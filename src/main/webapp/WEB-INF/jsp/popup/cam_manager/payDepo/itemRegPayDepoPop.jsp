...
<%--                        <button type="button" id="crmSelBtn" class="crmSelBtn k-grid-button k-button k-button-md k-button-solid k-button-solid-base" onclick="itemRegPayDepo.fn_popCamCrmList();">업체선택</button>--%>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <input type="text" id="depoAmt" style="text-align: right; width: 90%;" value="0" onkeyup="itemRegPayDepo.fn_calCost(this)" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                    </td>
