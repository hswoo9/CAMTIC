            ...
            $.each($("input[name='ymChkbox']:checked"), function(i, v){
                ...
                if(result.flag){
                    ...
                    for(var i=0; i<ls.length; i++){
                        ...
                        html += '            <td style="border: 1px solid black; text-align: right; font-size: 11px; padding: 10px 5px; background-color: #E6EEF7;">'+ comma(ls[i].SAL_TOT_PAY) +'</td>';
                        ...
                        totalSum += Number(ls[i].SAL_TOT_PAY);
