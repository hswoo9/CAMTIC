...
<script type="text/javascript" src="<c:url value='/js/intra/approval/approvalReaderSelectPop2.js?v=${today}'/>"></script>
...
<body>
	...
	<div style="padding: 20px">
					...
					<div id="deptUserInfoTabStrip" style="width: 420px;">
						<ul>
							...
							<div style="margin-left: 100px;">
								<span>성명</span>
								<input type="text" id="sEmpName" style="width: 180px;" class="k-input" onkeypress="if(window.event.keyCode==13){readerPop2.treeViewReload();}">
							</div>
						</ul>
					...
					<div id="readerTabStrip" style="width: 410px;">
						...
						<div>
							<div style="text-align: right">
								<button type="button" class="k-grid-add k-button k-button-md k-rounded-md k-button-solid k-button-solid-base" onclick="readerPop2.rowDblClick()" style="margin-bottom: 5px;">
		...
		<div style="text-align: right; margin-top : 15px">
			<button type="button" class="k-grid-button k-button k-button-md k-rounded-md k-button-solid k-button-solid-base" onclick="readerPop2.addReader()">
