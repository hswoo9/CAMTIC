...
<script type="text/javascript" src="/js/intra/docView/corpBankPrintPop.js"></script>
<script type="text/javascript" src="/js/loadingoverlay.min.js"/></script>

<input type="hidden" id="corpBankSn" value="${data.corpBankSn}"/>
...
<body>
    <div class="pop_head">
        <div style="position: absolute;">
            <h1>법인 통장 발급 신청서 인쇄</h1>
        </div>

        <div id="docControlBtnDiv">
            <button type='button' class='k-button k-button-solid k-button-solid-base' id="docApprovalPDFDownBtn" style="width: 70px; height: 25px; font-size: 12px;" onclick="corpBankPrintPop.print()">
