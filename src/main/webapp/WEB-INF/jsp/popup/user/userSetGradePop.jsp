...
<div style="padding:0;">
    <div class="table-responsive">
            <div class="card-header pop-header">
                <h3 class="card-title title_NM">직급/등급 관리</h3>
            ...
            <div style="padding: 20px 30px;">
                <table class="popTable table table-bordered mb-0">
                    ...
                    <tr>
                        <td class="text-center th-color"><input id="grade" type="text" style="width:30%;"> 급</td>
                        <td class="text-center th-color"><input id="rank" type="text" style="width:100%;"> </td>
                    ...
                    <tr>
                        <td class="text-center th-color"><input id="grade1" type="text" style="width:30%;"> 급</td>
                        <td class="text-center th-color"><input id="rank1" type="text" style="width:100%;"> </td>
                        <td class="text-center th-color">
