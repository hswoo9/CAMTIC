...
<script type="text/javascript" src="/js/intra/cam_project/docPrint/teamPrintPop.js"></script>
...
<body>
    <div class="pop_head">
        ...
        <div id="docControlBtnDiv">
            <button type='button' class='k-button k-button-solid k-button-solid-base' id="docApprovalPDFDownBtn"  style="width: 70px; height: 25px; font-size: 12px;" onclick="teamPrintPop.print()">
