        ...
        <div class="table-responsive">
            <table class="popTable table table-bordered mb-0">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="maxPartRate" value="0" maxlength="3" style="width: 80%; text-align: right" oninput="this.value = Number(this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1')) > 100 ? '100' : this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"> %
                    </td>
                </tr>
                <tr>
                    <th scope="row" class="text-center th-color">
