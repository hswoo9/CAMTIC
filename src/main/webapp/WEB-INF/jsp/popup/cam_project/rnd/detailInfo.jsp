...
<div style="padding: 10px">
    <div id="detailBtnDiv">
        <button type="button" id="delvSaveBtn" style="float: right; margin-bottom: 5px;" class="k-button k-button-solid-info" onclick="rndDetail.fn_save()">저장</button>
    ...
    <div class="table-responsive">
        <table class="popTable table table-bordered mb-0">
            ...
            <tr>
                ...
                <td colspan="3">
                    <textarea type="text" id="rndEtc" name="rndEtc" style="width: 100%"></textarea>
                </td>
            </tr>
            <tr>
                <th scope="row" class="text-center th-color">
                ...
                <td colspan="3">
                    ...
                    <input type="file" id="bsPlanFileList" name="bsPlanFileList" onchange="rndDetail.fileChange('bsPlan')" style="display: none" multiple>
            ...
            <tr>
                ...
                <td colspan="3">
                    ...
                    <input type="file" id="agreementFileList" name="agreementFileList" onchange="rndDetail.fileChange('agreement')" style="display: none" multiple>
            ...
            <tr>
                ...
                <td colspan="3">
                    ...
                    <input type="file" id="etcFileList" name="etcFileList" onchange="rndDetail.fileChange('etc')" style="display: none" multiple>
            ...
            <tr class="nowYearBetween">
                ...
                <td colspan="3">
                    ...
                    <div id="chgDiv" style="display: none;">
                        <button type="button" class="k-grid-button k-button k-button-md k-button-solid k-button-solid-base" onclick="rndDetail.fn_updNowYear();">변경</button>
