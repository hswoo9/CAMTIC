...
<div style="padding: 10px">
    <div id="btnDiv">
        ...
        <button type="button" id="saveBtn" style="float: right; margin-right: 5px; margin-bottom: 10px;" class="k-button k-button-solid-info" onclick="goodsInfo.fn_save()">저장</button>
