        ...
        <tr>
            <td style="border-width: 0 0 0 0; font-weight: normal; box-sizing: border-box;">
                <table border="3" style="border-collapse: collapse; margin: 0px;">
                    ...
                    <tr>
                        <td colspan="7" style="height:30px;background-color:#FFFFFF; text-align:left; width: 60px; border-top: none; border-right: none; border-left: none"><p style="font-size:17px;"><b>3. 구매예정</b></p></td>
                    </tr>
                    <tr>
...
<script>
    ...
    function approvalDataInit(){
        ...
        approvalParams.formId = "155";
        approvalParams.compSeq = "1000";
        approvalParams.empSeq = "${loginVO.uniqId}";
        approvalParams.docTitle = "[계획서]${loginVO.orgnztNm}-${loginVO.name}";
