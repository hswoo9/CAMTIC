...
<div style="padding:0;">
    <div class="table-responsive">
        <div class="card-header pop-header">
            <h3 class="card-title title_NM"><span style="position: relative; top: 3px;">회사 선택</span></h3>
        </div>
        ...
        $.ajax({
            ...
            success: function(rs){
                ...
                for(var i = 0 ; i < rs.list.length ; i++) {
                    ...
                    html += '<td>' + rs.list[i].ADDR + '</td>';
                    html += '<td>' + rs.list[i].TEL_NUM + '</td>';
    ...
    function rowDblClick(crmSn){
        ...
        $.ajax({
            ...
            success: function(rs){
                ...
                $("#crmName", opener.document).val(rs.data.CRM_NM);
                window.close();
            },
            error:function(){
                alert("다시 시도하시기 바랍니다.");
