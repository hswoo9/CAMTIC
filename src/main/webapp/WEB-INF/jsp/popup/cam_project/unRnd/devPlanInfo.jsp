...
<form id="unRndDevDraftFrm" method="post">
    ...
    <input type="hidden" id="menuCd" name="menuCd" value="unRndDev">
        ...
        <div id="addPSActive" style="display: none;">
            ...
            <table class="popTable table table-bordered mb-0" style="font-size: 12px; margin-top: 0">
                ...
                <tr>
                    ...
                    <td><input type="text" id="estTotAmt" style="text-align: right" disabled class="estTotAmt"/></td>
                    <td>
                        <input type="text" id="estOfc" class="estOfc" />
