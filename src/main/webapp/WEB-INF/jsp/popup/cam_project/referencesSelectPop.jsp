...
<script type="text/javascript">
	...
	function gridReload(){
		...
		mainGrid('/project/getFinalPartRateChangeDocList.do', searchAjaxData);
	}
	...
	function setReferencesAdd(docId, status, approvalEmpSeq, approvalDate){
        ...
        var data = {
            docId : docId,
            status : status,
            approvalEmpSeq : approvalEmpSeq,
            approvalDate : approvalDate,
            partRateVerSn : $("#partRateVerSn").val()
        }

        $.ajax({
            url : "/project/setReferencesAdd",
            data : data,
            type : "post",
            dataType : "json",
            success : function(rs){
                if(rs.code == 200){
                    ...
                    opener.parent.location.href = opener.document.location.pathname + "?pjtSn=" + opener.parent.$("#pjtSn").val() + "&tab=2";
