    ...
    <div class="table-responsive">
        <div class="card-header pop-header">
            ...
            <div id="purcBtnDiv" class="btn-st popButton">
                <button type="button" class="k-button k-button-solid-info" id="sendBtn" style="font-size: 12px;" onclick="mailReqReq.fn_saveBtn();">저장</button>
        ...
        <div style="padding: 20px 30px;">
            <table class="popTable table table-bordered mb-0">
                ...
                <thead id="order">
                <tr>
                    <th scope="row" class="text-center th-color"><span class="red-star">*</span>메일제목</th>
                    <td>
